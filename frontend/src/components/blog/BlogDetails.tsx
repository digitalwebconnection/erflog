  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10 pb-20 relative">
      ...
      <div className="mt-16 p-8 bg-slate-50 border border-slate-200 rounded-2xl text-center shadow-sm">
        ...
        <p className="text-slate-600 mb-6 max-w-lg mx-auto">Take control of your energy costs and join the sustainable revolution today with erfolg's expert solutions.</p>
        <button onClick={() => setOpenLeadPopup(true)}
          className="px-8 py-3 bg-[#FDC017] hover:bg-[#c19709] transition rounded-full text-white font-semibold shadow-md inline-block">
