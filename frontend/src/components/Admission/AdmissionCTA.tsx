          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-12 relative z-10">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-full sm:w-auto px-8 py-1 bg-[#FDC017] text-[#031627] font-bold rounded-2xl shadow-xl hover:shadow-[#FDC017]/20 transition-all duration-300 flex items-center justify-center gap-3 group"
              >
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="w-full sm:w-auto px-8 py-1 bg-white/5 border border-white/10 text-white font-bold rounded-2xl hover:bg-white/10 transition-all duration-300 flex items-center justify-center"
              >
                View Universities
              </motion.button>
            </div>
