...
const CountrySection = () => {
  ...
  const displayedCountries = Array.from({ length: Math.min(visibleCards, countries.length) }, (_, i) =>
            ...
            <AnimatePresence mode="popLayout">
              {displayedCountries.map((country, index) => (
                <motion.div
                  ...
                  className="relative group h-[380px] rounded-3xl overflow-hidden cursor-pointer shadow-lg"
                >
                  {/* Image */}
                  <img
                    src={country.image}
                  ...
                  {/* Hover Panel */}
                  <div className="absolute bottom-0 right-0 w-[85%] h-[42%] bg-white/95 backdrop-blur-md p-5 rounded-tl-3xl translate-x-full group-hover:translate-x-0 transition-transform duration-500 ease-out z-20 flex flex-col justify-center">
